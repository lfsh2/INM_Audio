...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.13/cropper.min.css" integrity="sha512-4tYjgxBjUJ6rxinOtfwM1HNPH1lZkJRK2I4bg9XBESIVzY/EzDWsFgVZ9cA81kKlKl4FVaS37H5nKtHT9asyHw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body>
    ...
    <!-- Using standalone cropper implementation from simple-crop.js -->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.13/cropper.min.js" integrity="sha512-6lplKUSl86rUVprDIjiKKsYoSzYrpUOgQtUXgzpNHSYZb3Y7xV7/mJL5bF+KEXZRPtJ4RJOwhJ/qGfXMT9umJQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="<?= base_url('assets/js/debug.js') ?>"></script>
    <script src="<?= base_url('assets/js/simple-crop.js') ?>"></script>
    <script src="<?= base_url('assets/js/costumizer.js') ?>"></script>
    <script>
    ...
    <script>
        // The cropper functionality has been moved to simple-crop.js
        // This script block is kept for backward compatibility
        console.log('Using standalone cropper implementation from simple-crop.js');
    </script>
</body>
